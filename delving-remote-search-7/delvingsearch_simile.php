...
<head>
  ...
  <script type="text/javascript"
          src="http://api.simile-widgets.org/exhibit/2.2.0/extensions/map/map-extension.js?gmapkey=ABQIAAAAOzjnxSh6DGJAeUM7wGYo6hQIDzCu4gYihK_Kj-yyuboyapyMhhSyUfDIFNa3VPzWaGr8kFg4A6ARUQ"></script>

  <script type="text/javascript">
    function mapConstructor(mapDiv) {
...
<table width="100%">
  <tr valign="top">
    ...
    <td ex:role="viewPanel">
      ...
      <div ex:role="view" ex:viewClass="Timeline" ex:start=".created" ex:colorKey=".type"></div>
      <div ex:role="view"></div>
      <div ex:role="view" viewclass="Map" latlng=".geography" center="61.439209,5.973408" zoom="4" ex:mapConstructor="mapConstructor"></div>

    </td>
    <td width="25%">
      <div ex:role="facet" ex:facetClass="TextSearch" ex:facetLabel="Search exhibit"></div>
      <div ex:role="facet" ex:expression=".type"></div>
      <div ex:role="facet" ex:expression=".municipality">
      </div>
